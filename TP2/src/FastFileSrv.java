...
public class FastFileSrv {
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        System.out.println("[FAST_FILE_SRV] " + self_address + " connecting to gateway: " + gateway_address);
        ...
        System.out.println("[FAST_FILE_SRV] Connection accepted from gateway.");
        ...
        while (true) {
            ...
            System.out.println("[FAST_FILE_SRV] Received packet from " + data_packet.getAddress());
            ...
            // Get file bytes
            Path file_path = Paths.get(System.getProperty("user.dir") + "/FastFiles" + file_name);
            ...
            if (Files.isReadable(file_path)) {
                ...
                while (bytes_left > 0) {
                    ...
                    data_socket1.send(data_packet);
                    System.out.println("[FAST_FILE_SRV] Sent packet to " + gateway_address
                            + " with fragment #" + byte_offset/Packet.Max_Data_Size);
                ...
                data_packet = new DatagramPacket(buf2, buf2.length, gateway_address, gateway_port);
                data_socket1.send(data_packet);
                System.out.println("[FAST_FILE_SRV] Sent error packet to " + gateway_address);
            }
