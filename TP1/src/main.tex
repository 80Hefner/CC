...
\begin{figure}[hbt!]
    \centering
    \frame{\includegraphics[width=.8\textwidth]{images/Q1/ping.png}}
    \caption{Trama ping}
\end{figure}

\begin{figure}[hbt!]
    \centering
    \frame{\includegraphics[width=.8\textwidth]{images/Q1/traceroute.png}}
    \caption{Trama traceroute}
\end{figure}

\begin{figure}[hbt!]
    \centering
    \frame{\includegraphics[width=.8\textwidth]{images/Q1/telnet.png}}
    \caption{Trama telnet}
\end{figure}

\begin{figure}[hbt!]
    \centering
    \frame{\includegraphics[width=.8\textwidth]{images/Q1/ftp.PNG}}
    \caption{Trama ftp}
\end{figure}

\begin{figure}[hbt!]
    \centering
    \frame{\includegraphics[width=.8\textwidth]{images/Q1/tftp.PNG}}
    \caption{Trama Tftp}
\end{figure}

\begin{figure}[hbt!]
    \centering
    \frame{\includegraphics[width=.8\textwidth]{images/Q1/browser.PNG}}
    \caption{Trama browser/http}
\end{figure}

\begin{figure}[hbt!]
    \centering
    \frame{\includegraphics[width=.8\textwidth]{images/Q1/nslookup.PNG}}
    \caption{Trama nslookup}
\end{figure}

\begin{figure}[hbt!]
    \centering
    \frame{\includegraphics[width=.8\textwidth]{images/Q1/ssh.PNG}}
    \caption{Trama ssh}
\end{figure}
